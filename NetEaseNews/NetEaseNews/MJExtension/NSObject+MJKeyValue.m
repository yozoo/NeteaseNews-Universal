...
//    if (([keyValues isKindOfClass:[NSDictionary class]]) == NO) {
////        MJExtensionBuildError([self class], @"keyValues参数不是一个字典");
//        NSError *error = [NSError errorWithDomain:@"keyValues参数不是一个字典" code:250 userInfo:nil];
